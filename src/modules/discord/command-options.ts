import {
	...
	type ApplicationCommandOptionLimitedNumber,
...
export const libraryOption: ApplicationCommandOption = {
	name: "library",
	description: "Select a library to query.",
...
export const versionOption: ApplicationCommandOption = {
	name: "version",
	description: "The documentation version to query.",
	type: CommandOptionType.STRING,
	autocomplete: true,
	required: false,
};
...
export const docsOptionFactory = (
	option: string,
